...
rabbitmqManagementHttpPort="8079"
...
function start() {
    ...
    if which mysql > /dev/null; then
        ...
        echo -e
        echo "You can find MySQL Server on [${mysqlHost}] port [${mysqlPort}]"
        echo -e
    ...
    echo -e
    echo "RabbitMQ Management available at [http://${rabbitmqHost}:${rabbitmqManagementHttpPort}]"
